...
**Test method**
* Verify that the [Resource locator](#resourcelocator) metadata pointing to valid URI and in this case, check manually that is pointing to a spatial data service (to a download service WMS, WFS view service, etc). It should not point to a general information web page. [Resource locator](#manualresourcelocatormessage) message. Otherwise report [brokenLink](#brokenLink). 
